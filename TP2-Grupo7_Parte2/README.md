...
Agregar LaserScan:
Topic: /scan
Cambiar la vista a TopDownOrtho.

Después usar 2D Pose Estimate para marcar aproximadamente en el mapa dónde está el robot y hacia dónde apunta.

En otra terminal mover el robot:
...
Ambos deben mostrar Active[3]

Ver de que estos comandos devuelvan datos:

timeout 8 ros2 run tf2_ros tf2_echo map odom
ros2 topic echo /amcl_pose --once

La prueba está correcta si el mapa y el robot aparecen en RViz, el robot se desplaza sobre el mapa, el LIDAR coincide razonablemente con los obstáculos y ambos comandos finales devuelven datos.
